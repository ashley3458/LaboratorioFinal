public class Empleado {
    ...
    public void setHorarioEntrada(String hora) { this.horarioEntrada = hora; }

    public String getHorarioSalida() { return horarioSalida; }
    public void setHorarioSalida(String hora) { this.horarioSalida = hora; }

    @Override
    public String toString() {
        return "Empleado{id=" + idEmpleado + ", nombre=" + nombre +
               ", cargo=" + cargo + "}";
    }
}
